...
public class Corridor
{
    ...
    public int SetupCorridor(Room room, IntRange length, IntRange roomWidth, IntRange roomHeight, int columns, int rows, bool firstCorridor)
    {
    ...
    public void SetupCorridor(Room room, IntRange length, IntRange roomWidth, IntRange roomHeight, int columns, int rows, int _direction)
    {
        // Set a random direction (a random index from 0 to 3, cast to Direction).
        if (_direction >= 4)
